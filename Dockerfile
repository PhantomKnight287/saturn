...
ARG EMAIL_PROXY
ENV EMAIL_PROXY=$EMAIL_PROXY
ARG EMAIL_PROXY_SECRET
ENV EMAIL_PROXY_SECRET=$EMAIL_PROXY_SECRET
...
ARG POLAR_PRODUCT_ID
ENV POLAR_PRODUCT_ID=$POLAR_PRODUCT_ID
ARG POLAR_PRODUCT_SLUG
ENV POLAR_PRODUCT_SLUG=$POLAR_PRODUCT_SLUG
