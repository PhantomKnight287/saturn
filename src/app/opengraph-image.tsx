      ...
      >
        <div tw='flex items-center justify-between w-full'>
          ...
          <span
            ...
            tw='text-[16px] text-white/30'
          >
            For freelancers & agencies
          </span>
        </div>
        <div style={{ gap: '28px', maxWidth: 800 }} tw='flex flex-col'>
          <div style={{ gap: '0px' }} tw='flex flex-col'>
            <span
              style={{ lineHeight: 0.95, letterSpacing: '-4px' }}
              tw='text-[88px] font-bold text-white'
            >
              Ship projects.
            </span>
            <span
          ...
          <p
            ...
            tw='text-[22px] text-white/40 m-0'
          >
